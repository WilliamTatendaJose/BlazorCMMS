-- COMPLETE FIX: Add Columns + Fix NULL Values
-- Run this script in SQL Server Management Studio

-- STEP 1: Mark initial migration as applied
...
PRINT 'Step 2: Columns added successfully!';
GO

-- STEP 3: Fix NULL values in existing records
...
PRINT 'Step 3: NULL values fixed successfully!';
GO

-- STEP 4: Mark the worksOrders migration as applied
