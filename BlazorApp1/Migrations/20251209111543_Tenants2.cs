        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EquipmentManufacturer = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    EstimatedDowntime = table.Column<double>(type: "float", nullable: false),
                    ActualDowntime = table.Column<double>(type: "float", nullable: true),
                    ...
                    RequestReason = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    ...
                    RejectedBy = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    Department = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Originator = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    AcknowledgedBy = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    ArtisanName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    OriginatorVerification = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    OriginatorVerificationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EngineeringForemanVerification = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    EngineeringForemanVerificationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    HODVerification = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    BreakdownType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
